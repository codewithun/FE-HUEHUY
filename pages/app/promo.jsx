...
import CommunityBottomBarComponent from '../../../components/construct.components/CommunityBottomBarComponent';
...
export default function KomunitasPromo() {
  ...
  const { tenantId, customerId, communityId } = router.query;
  ...
  if (!isClient) {
    return (
      <div className="lg:mx-auto lg:relative lg:max-w-md">
        ...
        {communityId ? (
          <CommunityBottomBarComponent active={'promo'} communityId={communityId} />
        ) : (
